...
~/startup_scripts/base16-default.dark.sh
...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:~/startup_scripts"
...
#alias tmux="TERM=screen-256color-bce tmux"
alias git-retrack="git rm -r --cached .; git add .; git commit -m 'fixed untracked files'"
